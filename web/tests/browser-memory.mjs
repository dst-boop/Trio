...
try {
  ...
  const workspace=await(await page.request.get(baseUrl+'/api/workspace')).json();await context.setExtraHTTPHeaders({'X-Trio-Account':workspace.accountId,'X-Trio-Workspace-Version':'6'});
