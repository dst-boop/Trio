  ...
  return <SidebarProvider style={{ '--sidebar-width': '248px' } as React.CSSProperties}>
    ...
    <main className="workspace">
      ...
      <div className="work-body">
        ...
        <WorkflowBriefs busy={busy || preferences.loading} prompt={prompt} onApply={text => { setPrompt(text); setDemo(false); promptRef.current?.focus(); toast('Brief prepared and Live mode selected. Review your model choices, then choose Ask Trio.'); }} />
