  ...
  return <SidebarProvider style={{ '--sidebar-width': '248px' } as React.CSSProperties}>
    ...
    <main className="workspace">
      ...
      <div className="work-body">
        ...
        <AudioTranscription accountId={account?.userId} apiKey={connections.openai.enabled ? connections.openai.key : ''} live={!demo} disabled={busy} question={prompt} onAppend={value => { setPrompt(value); promptRef.current?.focus(); }} onConnections={() => setSettings(true)} />
