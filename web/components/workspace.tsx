  ...
  return <SidebarProvider style={{ '--sidebar-width': '248px' } as React.CSSProperties}>
    ...
    <main className="workspace">
      ...
      <div className="work-body">
        ...
        <WorkflowBriefs busy={busy || preferences.loading} prompt={prompt} onApply={text => { setPrompt(text); setDemo(false); promptRef.current?.focus(); toast('Brief prepared. Review your mode and connections, then choose Ask Trio.'); }} />
