...
export function NextActions({ sessions, busy, onSave, onOpenPlan, filter, setFilter, search, setSearch }: { sessions: Session[]; busy: boolean; onSave: (id: string, index: number, plan: WorkPlan | null) => boolean; onOpenPlan: (id: string, index: number) => void; filter: ActionFilter; setFilter: (filter: ActionFilter) => void; search: string; setSearch: (search: string) => void }) {
